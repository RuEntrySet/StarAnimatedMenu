...
public class ActionBar {
	...
	public static void sendActionBar(Player player, String text) {
		...
		try {
			Object chat = Objects.requireNonNull(getNMS("IChatBaseComponent")).getDeclaredClasses()[0]
			...
			Constructor<?> actionConstructor = Objects.requireNonNull(getNMS("PacketPlayOutChat"))
